...
This branch contains only the Python dashboard code, deployed to [Streamlit Community
Cloud](https://streamlit.io/cloud). The full Java project (Playwright tests, Gradle build, schema migrations) lives on
the `main` branch.
...
The `data/test-statistics.db` file is a snapshot of the Turso database produced by the JUnit 5 test suite. It is
included for demo purposes and does not contain sensitive information.
